...
TEST_GROUP_RUNNER(Foo)
{
	...
	RUN_TEST_CASE(Foo, len2__RADIX_On_INT_0_array);
	RUN_TEST_CASE(Foo, len2__RADIX_On_INT_0_status);
	RUN_TEST_CASE(Foo, len2__BUBBLE_On2_INT_0_array);
	RUN_TEST_CASE(Foo, len2__BUBBLE_On2_INT_0_status);
	RUN_TEST_CASE(Foo, len2__INSERTION_On2_INT_0_array);
	RUN_TEST_CASE(Foo, len2__INSERTION_On2_INT_0_status);
	RUN_TEST_CASE(Foo, len2__SELECTION_On2_INT_0_array);
	RUN_TEST_CASE(Foo, len2__SELECTION_On2_INT_0_status);
	RUN_TEST_CASE(Foo, len2__HEAP_Onlogn_INT_0_array);
	RUN_TEST_CASE(Foo, len2__HEAP_Onlogn_INT_0_status);
	RUN_TEST_CASE(Foo, len2__MERGE_Onlogn_INT_0_array);
	RUN_TEST_CASE(Foo, len2__MERGE_Onlogn_INT_0_status);
	RUN_TEST_CASE(Foo, len2__QUICK_Onlogn_INT_0_array);
	RUN_TEST_CASE(Foo, len2__QUICK_Onlogn_INT_0_status);
	RUN_TEST_CASE(Foo, len20__COUNTING_On_INT_0_array);
	RUN_TEST_CASE(Foo, len20__COUNTING_On_INT_0_status);
	RUN_TEST_CASE(Foo, len20__RADIX_On_INT_0_array);
	RUN_TEST_CASE(Foo, len20__RADIX_On_INT_0_status);
	RUN_TEST_CASE(Foo, len20__BUBBLE_On2_INT_0_array);
	RUN_TEST_CASE(Foo, len20__BUBBLE_On2_INT_0_status);
	RUN_TEST_CASE(Foo, len20__INSERTION_On2_INT_0_array);
	RUN_TEST_CASE(Foo, len20__INSERTION_On2_INT_0_status);
	RUN_TEST_CASE(Foo, len20__SELECTION_On2_INT_0_array);
	RUN_TEST_CASE(Foo, len20__SELECTION_On2_INT_0_status);
	RUN_TEST_CASE(Foo, len20__HEAP_Onlogn_INT_0_array);
	RUN_TEST_CASE(Foo, len20__HEAP_Onlogn_INT_0_status);
	RUN_TEST_CASE(Foo, len20__MERGE_Onlogn_INT_0_array);
	RUN_TEST_CASE(Foo, len20__MERGE_Onlogn_INT_0_status);
	RUN_TEST_CASE(Foo, len20__QUICK_Onlogn_INT_0_array);
	RUN_TEST_CASE(Foo, len20__QUICK_Onlogn_INT_0_status);
